...
// Icons as React Components (using basic Path SVGs)
const HomeIcon = () => (
...
export const navConfig = [
    { path: '/', name: 'Home', color: '#2a75bb', icon: <HomeIcon /> },
    { path: '/projects', name: 'Projects', color: '#8a2be2', icon: <ProjectsIcon /> },
    { path: '/analytics', name: 'Analytics', color: '#00ccff', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg> },
    { path: '/skills', name: 'Skills', color: '#00ffff', icon: <SkillsIcon /> },
    { path: '/certifications', name: 'Certifications', color: '#2ebf91', icon: <CertsIcon /> },
    { path: '/achievements', name: 'Achievements', color: '#ffd700', icon: <AchvIcon /> },
    { path: '/journey', name: 'Journey', color: '#ff69b4', icon: <JourneyIcon /> },
    { path: '/experience', name: 'Work Experience', color: '#ff8c00', icon: <ExpIcon /> },
    { path: '/cv', name: 'CV & Resume', color: '#008080', icon: <CVIcon /> },
    { path: '/contact', name: 'Contact', color: '#ff4444', icon: <ContactIcon /> },
];
